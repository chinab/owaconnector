...
/**
 * <code>ParentElement</code> wraps en element of the parent set of a resource.
 * A <code>java.util.Set</code> of <code>ParentElement</code> objects may serve
 * as the value object of the <code>ParentSet</code> DavProperty.
 */
public class ParentElement implements XmlSerializable {
	...
	public static ParentElement createFromXml(Element root) throws DavException {
		if (!DomUtil.matches(root, BindConstants.XML_PARENT,
	...
	public Element toXml(Document document) {
		Element parentElt = DomUtil.createElement(document,
				BindConstants.XML_PARENT, BindConstants.NAMESPACE);
