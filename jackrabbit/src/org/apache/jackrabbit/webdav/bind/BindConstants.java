 ...
 * headers, Xml elements and property names defined by the BIND specification.
 */
public interface BindConstants {
	...
	/**
	 * local names of XML elements used in the request bodies of the methods
	 ...
	 */
	public static final DavPropertyName RESOURCEID = DavPropertyName
			.create("resource-id");
	public static final DavPropertyName PARENTSET = DavPropertyName
			.create("parent-set");
}
