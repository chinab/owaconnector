...
public class UnbindInfo implements XmlSerializable {
	...
	/**
	 * Build an <code>UnbindInfo</code> object from the root element present in
	 * the request body.
	 * 
	 * @param root
	...
	public static UnbindInfo createFromXml(Element root) throws DavException {
		if (!DomUtil.matches(root, BindConstants.XML_UNBIND,
	...
	public Element toXml(Document document) {
		Element unbindElt = DomUtil.createElement(document,
				BindConstants.XML_UNBIND, BindConstants.NAMESPACE);
