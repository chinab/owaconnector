 ...
 * <code>VersionableResource</code> a resource, that has already been put under
 * version-control. This resource can be checked-in, checked-out and has its own
 * {@link VersionHistoryResource version history}.
 * <p/>
 * RFC 3253 defines the following required properties for a version-controlled
 ...
 * </ul>
 * 
 * If the Version-Controlled-Collection feature is supported (see section 14 of
 * RFC 3253) the following computed property is required:
 * <ul>
...
public interface VersionControlledResource extends VersionableResource {
	...
	/**
	 * Methods defined for a checked-in version-controlled resource: CHECKOUT,
	 * UPDATE, MERGE, LABEL
	 */
	public String methods_checkedIn = "CHECKOUT, UPDATE, MERGE, LABEL";
	/**
	 * Methods defined for a checked-out version-controlled resource: CHECKIN,
	 * MERGE
	 */
	 ...
	 * include various combinations of automated checkout, write lock and
	 * checkin as well as failure until the resource is explicitely checked-out.<br>
	 * See <a href="http://www.ietf.org/rfc/rfc3253.txt">RFC 3253</a> for a
	 * detailed description.
	 */
	public static final DavPropertyName AUTO_VERSION = DavPropertyName.create(
			"auto-version", DeltaVConstants.NAMESPACE);
	 ...
	 * </pre>
	 */
	public static final DavPropertyName VERSION_HISTORY = DavPropertyName
			.create("version-history", DeltaVConstants.NAMESPACE);
	 ...
	 * </pre>
	 */
	public static final DavPropertyName CHECKED_IN = DavPropertyName.create(
			"checked-in", DeltaVConstants.NAMESPACE);

	/**
	 * The DAV:checked-out property identifies the base version of this
	 * resource. It is the same that was identified by the DAV:checked-in
	 * property at the time the resource was checked out. This property is
	 * removed when the resource is checked in.<br>
	 * This property is defined to have the following format:
	 * 
	 * <pre>
	 ...
	 * @see #CHECKED_IN
	 */
	public static final DavPropertyName CHECKED_OUT = DavPropertyName.create(
			"checked-out", DeltaVConstants.NAMESPACE);
	 ...
	 */
	public static final DavPropertyName PREDECESSOR_SET = DavPropertyName
			.create("predecessor-set", DeltaVConstants.NAMESPACE);

	/**
	 * This property determines the DAV:checkin-fork property of the version
	 * that results from checking in this resource.
	 */
	public static final DavPropertyName CHECKIN_FORK = DavPropertyName.create(
			"checkin-fork", DeltaVConstants.NAMESPACE);

	/**
	 * This property determines the DAV:checkout-fork property of the version
	 * that results from checking in this resource.
	 */
	public static final DavPropertyName CHECKOUT_FORK = DavPropertyName.create(
			"checkout-fork", DeltaVConstants.NAMESPACE);

	/**
	 * This property identifies each version that is to be merged into this
	 * checked-out resource. This property is set, whenever a MERGE request with
	 * the DAV:no-auto-merge flag succeeded. The client then must confirm each
	 * single merge by removing the version from the DAV:merge-set or moving it
	 * the the versions DAV:predecessor-set.<br>
	 * This property is defined to have the following format:
	 * 
	 * <pre>
	 ...
	 * @see #merge(MergeInfo)
	 */
	public static final DavPropertyName MERGE_SET = DavPropertyName.create(
			"merge-set", DeltaVConstants.NAMESPACE);
	 ...
	 * @see #merge(MergeInfo)
	 */
	public static final DavPropertyName AUTO_MERGE_SET = DavPropertyName
			.create("auto-merge-set", DeltaVConstants.NAMESPACE);
	 ...
	 */
	public static final DavPropertyName UNRESERVED = DavPropertyName.create(
			"activity-set", DeltaVConstants.NAMESPACE);

	/**
	 * DAV:activity-set is a property for a checked-out resource, if the server
	 * supports the activity feature.<br>
	 * This property determines the DAV:activity-set property of the version
	 * that results from checking in this resource.
	 * 
	 * @see VersionResource#ACTIVITY_SET
	 */
	public static final DavPropertyName ACTIVITY_SET = DavPropertyName.create(
			"activity-set", DeltaVConstants.NAMESPACE);

	/**
	 * If the 'Version-Controlled-Collection Feature' is supported the
	 * DAV:eclipsed-set property present on a collection identifies all internal
	 * members that are not version-controlled and hide a vc internal member
	 * with the same name.
	 * <p/>
	 * This property is defined to have the following format:
	 * 
	 ...
	 */
	public static final DavPropertyName ECLIPSED_SET = DavPropertyName.create(
			"eclipsed-set", DeltaVConstants.NAMESPACE);

	/**
	 * If the 'Baseline' feature is supported,
	 * DAV:baseline-controlled-collection is a required property of any
	 * version-controlled resource, that represents a 'configuration'. It
	 * identifies the collection that contains the version-controlled resources
	 * whose versions are tracked by this configuration.
	 * <p/>
	 * 
	 * This property is defined to have the following format:
	 * 
	 ...
	 * 
	 * @see DeltaVConstants#VERSION_CONTROLLED_CONFIGURATION for the
	 *      corresponding property, that is required for all resources that are
	 *      contained in this version-controlled-configuration.
	 */
	public static final DavPropertyName BASELINE_CONTROLLED_COLLECTION = DavPropertyName
			.create("baseline-controlled-collection", DeltaVConstants.NAMESPACE);

	/**
	 * This property is mandatory for all checked-out
	 * version-controlled-configuration resources. It determines the
	 * DAV:subbaseline-set property of the baseline that results from checking
	 * in this resource.
	 * <p/>
	 * 
	 * This property is defined to have the following format:
	 ...
	 */
	public static final DavPropertyName SUBBASELINE_SET = DavPropertyName
			.create("subbaseline-set", DeltaVConstants.NAMESPACE);
	...
	/**
	 * Returns the <code>VersionHistoryResource</code>, that is referenced in
	 * the '{@link #VERSION_HISTORY version-history}' property.
	 * 
	 * @return
	 * @throws DavException
	 */
	...
	/**
	 * Modify the labels of the version referenced by the DAV:checked-in
	 * property of this checked-in version-controlled resource. If the resource
	 * is not checked-in the request must fail.
	 * 
	 * @param labelInfo
	 * @throws org.apache.jackrabbit.webdav.DavException
	 * @see LabelInfo
	 * @see VersionResource#label(LabelInfo) for the pre- and postcondition of a
	 *      successful LABEL request.
	 */
