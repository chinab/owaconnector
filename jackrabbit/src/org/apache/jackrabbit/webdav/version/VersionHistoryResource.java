...
/**
 * <code>VersionHistoryResource</code> represents a collection that has all
 * versions of a given version-controlled resource as members.
 * <p/>
 ...
 * DAV:resourcetype} property must indicate 'DAV:version-history'.
 * 
 * @see DeltaVResource
...
public interface VersionHistoryResource extends DeltaVResource {
	...
	/**
	 * Computed (protected) property identifying the root version of this
	 * version history.
	 */
	public static final DavPropertyName ROOT_VERSION = DavPropertyName.create(
			"root-version", DeltaVConstants.NAMESPACE);
	 ...
	 * @see #getVersions()
	 */
	public static final DavPropertyName VERSION_SET = DavPropertyName.create(
			"version-set", DeltaVConstants.NAMESPACE);

	/**
	 * Returns an array of <code>VersionResource</code>s containing all versions
	 * that are a member of this resource.
	 * 
	 * @return all <code>VersionResource</code>s that belong to this version
	 *         history.
