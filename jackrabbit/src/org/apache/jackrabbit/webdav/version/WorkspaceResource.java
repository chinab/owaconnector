 ...
 * <p/>
 * 
 * The workspace resource must support all methods defined for a
 * DeltaV-compliant collection. Since no additional methods are required for a
 * workspace this interface mainly acts as marker.
 * <p/>
...
public interface WorkspaceResource extends DeltaVResource {
	 ...
	 */
	public static final DavPropertyName WORKSPACE_CHECKOUT_SET = DavPropertyName
			.create("workspace-checkout-set", DeltaVConstants.NAMESPACE);
	 ...
	 * {@link org.apache.jackrabbit.webdav.property.HrefProperty HrefProperty}
	 */
	public static final DavPropertyName CUURENT_ACTIVITY_SET = DavPropertyName
			.create("current-activity-set", DeltaVConstants.NAMESPACE);
	 ...
	 * {@link org.apache.jackrabbit.webdav.property.HrefProperty HrefProperty}
	 */
	public static final DavPropertyName BASELINE_CONTROLLED_COLLECTION_SET = DavPropertyName
			.create("baseline-controlled-collection-set",
