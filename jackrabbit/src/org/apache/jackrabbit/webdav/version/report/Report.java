 ...
 * to a REPORT request. The REPORT method is a required feature to all DeltaV
 * resources.
 * 
...
public interface Report extends XmlSerializable {
	 ...
	 * Please note that this methods should perform basic validation checks in
	 * order to prevent execeptional situations during the xml serialization.
	 * 
	 * @param resource
	 * @param info
	 * @throws DavException
	...
	/**
	 * Returns true if this <code>Report</code> will send a
	 * <code>MultiStatus</code> response.<br>
	 * Please note that RFC 3253 that the the response must be a 207
	 * Multi-Status, if a Depth request header is present.
	 * 
	 * @return
	 */
