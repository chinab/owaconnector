 ...
 */
public class SupportedMethodSetProperty extends AbstractDavProperty implements
		DeltaVConstants {
	...
	public Element toXml(Document document) {
		...
		for (String method : methods) {
			Element methodElem = DomUtil.addChildElement(elem,
					XML_SUPPORTED_METHOD, DeltaVConstants.NAMESPACE);
			DomUtil.setAttribute(methodElem, "name", DeltaVConstants.NAMESPACE,
					method);
		}
		return elem;
	}
