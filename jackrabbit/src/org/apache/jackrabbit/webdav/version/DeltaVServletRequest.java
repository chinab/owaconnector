...
public interface DeltaVServletRequest extends DavServletRequest {
	...
	/**
	 * Return the request body as <code>LabelInfo</code> object or
	 * <code>null</code> if parsing the request body or the creation of the
	 * label info failed.
	 * 
	...
	/**
	 * Return the request body as <code>MergeInfo</code> object or
	 * <code>null</code> if the creation failed due to invalid format.
	 * 
	...
	/**
	 * Returns the {@link OptionsInfo} present with the request or
	 * <code>null</code>.
	 * 
	 ...
	 * {@link org.apache.jackrabbit.webdav.DavConstants#HEADER_DEPTH Depth
	 * header}, is {@link org.apache.jackrabbit.webdav.DavConstants#DEPTH_0}. If
	 * the requuest body could not be parsed into an {@link org.w3c.dom.Element}
	 ...
	 * <code>UpdateInfo</code> object. If the request body is missing or does
	 * not of the required format <code>null</code> is returned.
	 * 
