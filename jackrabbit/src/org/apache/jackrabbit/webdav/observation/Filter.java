...
public class Filter implements XmlSerializable {
	...
	public Filter(String filterName, Namespace filterNamespace,
			String filterValue) {
		if (filterName == null) {
	...
	public boolean isMatchingFilter(String localName, Namespace namespace) {
		boolean matchingNsp = (filterNamespace == null) ? namespace == null
				: filterNamespace.equals(namespace);
		return filterName.equals(localName) && matchingNsp;
	}

	public Element toXml(Document document) {
		return DomUtil.createElement(document, filterName, filterNamespace,
				filterValue);
	}
