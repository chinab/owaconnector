...
/**
 * <code>AbstractLockEntry</code> provides the generic
 * {@link org.apache.jackrabbit.webdav.xml.XmlSerializable#toXml} method.
 */
public abstract class AbstractLockEntry implements LockEntry, DavConstants {
	...
	public Element toXml(Document document) {
		Element entry = DomUtil.createElement(document, XML_LOCKENTRY,
				NAMESPACE);
