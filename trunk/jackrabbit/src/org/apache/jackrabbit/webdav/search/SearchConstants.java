...
/**
 * <code>SearchConstants</code> interface provide constants for request and
 * response headers, Xml elements and property names used for WebDAV search.
 */
public interface SearchConstants {
	 ...
	 * {@link DavConstants#NAMESPACE DAV:} namespace. This is not correct for
	 * the underlying specification is still in a draft state. See also the
	 * editorial note inside the <a href="http://greenbytes.de/tech/webdav/draft-reschke-webdav-search-latest.html#rfc.section.1.5"
	 * >Internet Draft WebDAV Search</a> document.
	 */
	 ...
	 */
	public static final String BASICSEARCH = NAMESPACE.getPrefix()
			+ "basicsearch";

	// ---< Headers
	// >------------------------------------------------------------
	/**
	 * The DASL response header specifing the query languages supported by the
	 * requested resource.
	 */
	 ...
	 * {@link #QUERY_GRAMMER_SET supported-query-grammer-set property}.
	 */
	 ...
	 * {@link #XML_SEARCHREQUEST} in order to access a given query schema.
	 */
	...
	// >-----------------------------------------------------
	/**
	 * Property indicating the set of query languages the given resource is able
	 * deal with. The property has the following definition:<br>
	 * 
	 * <pre>
	...
	public static final DavPropertyName QUERY_GRAMMER_SET = DavPropertyName
			.create("supported-query-grammar-set", NAMESPACE);
}