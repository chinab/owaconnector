...
public class DavMethods {
	...
	/**
	 * The webdav PROPFIND method and public constant as defined by <a
	...
	/**
	 * The webdav PROPPATCH method and public constant as defined by <a
	 * href="http://www.ietf.org/rfc/rfc2518.txt">RFC 2518</a>
	 */
	...
	/**
	 * The webdav MKCOL (make collection) method and public constant as defined
	...
	/**
	 * The webdav COPY method and public constant as defined by <a
	 * href="http://www.ietf.org/rfc/rfc2518.txt">RFC 2518</a>
	 */
	...
	/**
	 * The webdav MOVE method and public constant as defined by <a
	 * href="http://www.ietf.org/rfc/rfc2518.txt">RFC 2518</a>
	 */
	...
	/**
	 * The webdav LOCK method and public constant as defined by <a
	 * href="http://www.ietf.org/rfc/rfc2518.txt">RFC 2518</a>
	 */
	...
	/**
	 * The webdav UNLOCK method and public constant as defined by <a
	 * href="http://www.ietf.org/rfc/rfc2518.txt">RFC 2518</a>
	 */
	...
	/**
	 * The webdav ORDERPATCH method and public constant defined by <a
	 * href="http://www.ietf.org/rfc/rfc3648.txt">RFC 3648</a>.
	 */
	...
	/**
	 * The webdav SEARCH method and public constant as defined by the Webdav
	 * Search internet draft.
	 */
	public static final int DAV_SEARCH = DAV_POLL + 1;
	public static final String METHOD_SEARCH = "SEARCH";

	/**
	 * The webdav REPORT method and public constant defined by <a
	 * href="http://www.ietf.org/rfc/rfc3253.txt">RFC 3253</a>
	 */
	public static final int DAV_REPORT = DAV_SEARCH + 1;
	public static final String METHOD_REPORT = "REPORT";

	/**
	 * The webdav VERSION-CONTROL method and public constant defined by <a
	 * href="http://www.ietf.org/rfc/rfc3253.txt">RFC 3253</a>
	 */
	...
	/**
	 * The webdav CHECKIN method and public constant defined by <a
	 * href="http://www.ietf.org/rfc/rfc3253.txt">RFC 3253</a>
	 */
	...
	/**
	 * The webdav CHECKOUT method and public constant defined by <a
	 * href="http://www.ietf.org/rfc/rfc3253.txt">RFC 3253</a>
	 */
	...
	/**
	 * The webdav UNCHECKOUT method and public constant defined by <a
	 * href="http://www.ietf.org/rfc/rfc3253.txt">RFC 3253</a>
	 */
	...
	/**
	 * The webdav LABEL method and public constant defined by <a
	 * href="http://www.ietf.org/rfc/rfc3253.txt">RFC 3253</a>
	 */
	...
	/**
	 * The webdav MERGE method and public constant defined by <a
	 * href="http://www.ietf.org/rfc/rfc3253.txt">RFC 3253</a>
	 */
	...
	/**
	 * The webdav UPDATE method and public constant defined by <a
	 * href="http://www.ietf.org/rfc/rfc3253.txt">RFC 3253</a>
	 */
	...
	/**
	 * The webdav MKWORKSPACE method and public constant defined by <a
	 * href="http://www.ietf.org/rfc/rfc3253.txt">RFC 3253</a>
	 */
	...
	/**
	 * The webdav BASELINE-CONTROL method and public constant defined by <a
	 * href="http://www.ietf.org/rfc/rfc3253.txt">RFC 3253</a>
	 */
	...
	/**
	 * The webdav MKACTIVITY method and public constant defined by <a
	 * href="http://www.ietf.org/rfc/rfc3253.txt">RFC 3253</a>
	 */
	...
	/**
	 * The webdav ACL method and public constant defined by <a
	 * href="http://www.ietf.org/rfc/rfc3744.txt">RFC 3744</a>
	 */
	public static final int DAV_ACL = DAV_MKACTIVITY + 1;
	public static final String METHOD_ACL = "ACL";

	/**
	 * The webdav REBIND method and public constant defined by the BIND
	 * specification
	 */
	...
	/**
	 * The webdav UNBIND method and public constant defined by the BIND
	 * specification
	 */
	...
	/**
	 * The webdav BIND method and public constant defined by the BIND
	 * specification
	 */
	...
	static {
		...
		labelMethods = new int[] { DAV_GET, DAV_HEAD, DAV_OPTIONS,
				DAV_PROPFIND, DAV_LABEL, DAV_COPY };

		deltaVMethods = new int[] { DAV_REPORT, DAV_VERSION_CONTROL,
				DAV_CHECKIN, DAV_CHECKOUT, DAV_UNCHECKOUT, DAV_LABEL,
				DAV_MERGE, DAV_UPDATE, DAV_MKWORKSPACE, DAV_BASELINE_CONTROL,
				DAV_MKACTIVITY };
	}
	...
	/**
	 * Returns <code>true</code> if the request is to create a collection
	 * resource. True for <code>MKCOL</code> and <code>MKWORKSPACE</code>
	 * requests.
	 * 
	...
	/**
	 * Returns <code>true</code> if the request is to create a resource. True
	 * for <code>PUT</code>, <code>POST</code>, <code>MKCOL</code> and
	 * <code>MKWORKSPACE</code> requests.
	 * 
	...
	public static boolean isCreateRequest(DavServletRequest request) {
		int methodCode = getMethodCode(request.getMethod());
		return (methodCode == DAV_PUT || methodCode == DAV_POST
				|| methodCode == DAV_MKCOL || methodCode == DAV_MKWORKSPACE);
	}
