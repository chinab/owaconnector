...
public class ReportMethod extends DavMethodBase {
	 ...
	 *         or {@link DavServletResponse#SC_MULTI_STATUS 207 (Multi Status)}.
	 *         If the report request included a depth other than
	 *         {@link DavConstants#DEPTH_0 0} a multi status response is
	 *         required.
	 */
	protected boolean isSuccess(int statusCode) {
		if (isDeep) {
			...
			return statusCode == HttpServletResponse.SC_OK
					|| statusCode == DavServletResponse.SC_MULTI_STATUS;
		}
	}
}