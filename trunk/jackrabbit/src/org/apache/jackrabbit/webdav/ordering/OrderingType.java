 ...
 * DAV:ordering-type} property as defined by <a
 * href="http://www.ietf.org/rfc/rfc3648.txt">RFC 3648</a>. This property is
...
public class OrderingType extends HrefProperty implements OrderingConstants {
	 ...
	 * value). The default value is specified to be
	 * {@link #ORDERING_TYPE_UNORDERED}.
	 */
	public OrderingType() {
		this(null);
	}
	...
	public OrderingType(String href) {
		...
		super(ORDERING_TYPE, (href != null) ? href : ORDERING_TYPE_UNORDERED,
				true);
	}
}