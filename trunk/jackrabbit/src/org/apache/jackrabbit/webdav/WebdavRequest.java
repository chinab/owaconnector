 ...
 * defined by {@link org.apache.jackrabbit.webdav.DavServletRequest}
 * encapsulting the core Webdav specification (RFC 2518) as well as the various
 * extensions used for observation and transaction support, ordering of
...
public interface WebdavRequest extends DavServletRequest,
		...
		TransactionDavServletRequest, DeltaVServletRequest, BindServletRequest {
}
