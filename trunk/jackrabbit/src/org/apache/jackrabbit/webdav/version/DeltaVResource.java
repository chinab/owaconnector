 ...
 * <li>{@link DeltaVConstants#SUPPORTED_LIVE_PROPERTY_SET
 * DAV:supported-live-property-set}</li>
...
public interface DeltaVResource extends DavResource {
	...
	/**
	 * The generic deltaV complient resource defines one additional method
	 * REPORT.
	 * 
	 ...
	 * Please note that no resource must exist at the location of the new
	 * workspace.
	 * 
	 * @param workspace
	 ...
	 * 
	 * @param optionsInfo
	 * @return object to be included to the OPTIONS response body or
	 *         <code>null</code> if the specified optionsInfo was
	 ...
	 * @throws DavException
	 *             if the given hrefPropertyName does point to an unknown
	 *             property or does not represent the name of a
	 *             {@link org.apache.jackrabbit.webdav.property.HrefProperty
	 *             href property}. Finally the exception may be caused if the
	 *             property contains the href of a non-existing resource, which
	 *             cannot be resolved.
