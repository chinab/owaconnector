 ...
 * "line of descent", where a line of descent is a sequence of versions
 * connected by successor relationships. If an activity selects versions from
 * multiple version histories, the versions selected in each version history
 ...
 * <li>Note, that the
 * {@link org.apache.jackrabbit.webdav.DavConstants#PROPERTY_RESOURCETYPE
 * DAV:resourcetype} property returned by an Activity resource must be
 * {@link org.apache.jackrabbit.webdav.property.ResourceType#ACTIVITY
 * DAV:activity}</li>
 * </ul>
 * <p/>
...
public interface ActivityResource extends DeltaVResource {
	 ...
	 */
	public static final DavPropertyName ACTIVITY_VERSION_SET = DavPropertyName
			.create("activity-version-set", DeltaVConstants.NAMESPACE);
	 ...
	 * {@link org.apache.jackrabbit.webdav.property.HrefProperty HrefProperty}
	 */
	public static final DavPropertyName ACTIVITY_CHECKOUT_SET = DavPropertyName
			.create("activity-checkout-set", DeltaVConstants.NAMESPACE);
	 ...
	 * version for merging, the latest version in this extended set is the one
	 * that will be merged.
	 * <p/>
	 ...
	 * {@link org.apache.jackrabbit.webdav.property.HrefProperty HrefProperty}
	 */
	public static final DavPropertyName SUBACTIVITY_SET = DavPropertyName
			.create("subactivity-set", DeltaVConstants.NAMESPACE);
	 ...
	 * {@link org.apache.jackrabbit.webdav.property.HrefProperty HrefProperty}
	 */
	public static final DavPropertyName CURRENT_WORKSPACE_SET = DavPropertyName
			.create("current-workspace-set", DeltaVConstants.NAMESPACE);
