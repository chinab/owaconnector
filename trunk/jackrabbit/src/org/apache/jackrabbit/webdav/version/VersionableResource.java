 ...
 * <p/>
 * RFC 3253 defines the following required properties for a versionable
 * resource:
 * <ul>
...
public interface VersionableResource extends DeltaVResource {
	 ...
	 * this resource is already version-controlled this resource is not
	 * affected. If however, this resource is not versionable an
	 * <code>DavException</code> (error code:
	 * {@link org.apache.jackrabbit.webdav.DavServletResponse#SC_METHOD_NOT_ALLOWED}
	 * is thrown. The same applies, if this resource is versionable but its
	 * current state does not allow to made it a version-controlled one or if
